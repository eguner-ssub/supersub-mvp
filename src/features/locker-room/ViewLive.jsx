    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-full">
                <p className="text-gray-400 animate-pulse font-bold">Scanning Live Action...</p>
            </div>
        );
    }
    ...
    return (
        <div className="h-full overflow-y-auto scrollbar-hide p-6 pb-32">
            <div className="mb-6 text-center">
                ...
                <p className="text-gray-500 text-xs mt-1 uppercase tracking-widest font-bold">Matches in Progress</p>
            </div>
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
                {liveBets.map((bet) => (
                    <div
                        key={bet.id}
                        className="bg-zinc-900 border-2 border-emerald-500 rounded-xl p-6 shadow-[0_0_20px_rgba(16,185,129,0.2)] hover:shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all border border-white/5"
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 className="text-xl font-black text-white uppercase leading-none mb-1">{bet.match_title}</h3>
