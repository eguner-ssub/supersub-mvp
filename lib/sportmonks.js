...
export function getTopScorers(seasonId) {
  return request(`/topscorers/seasons/${seasonId}`, {
...
/** All fixture/match states (for reference cache). */
export function getStates() {
  return request('https://api.sportmonks.com/v3/core/states');
}

/** All entity types (for reference cache). */
export function getTypes() {
  return request('https://api.sportmonks.com/v3/core/types');
}
