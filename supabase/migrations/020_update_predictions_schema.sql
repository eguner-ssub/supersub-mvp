...
ALTER TABLE predictions
  ADD COLUMN IF NOT EXISTS team_id UUID REFERENCES teams(id) DEFAULT NULL;
...
CREATE INDEX IF NOT EXISTS idx_predictions_team_id ON predictions(team_id) WHERE team_id IS NOT NULL;
